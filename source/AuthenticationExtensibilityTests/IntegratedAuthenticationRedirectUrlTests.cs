...
namespace AuthenticationExtensibilityTests
{
    ...
    public class IntegratedAuthenticationRedirectUrlTests
    {
        ...
        [TestCase("http://localhost:8065", "http://localhost:9005", new [] { "http://localhost:9005" }, ExpectedResult = true)]
        [TestCase("http://localhost:8065", "https://localhost:9005", new[] { "https://localhost:9005" }, ExpectedResult = true)]
        [TestCase("https://localhost:8065", "https://localhost:9005", new[] { "https://localhost:9005" }, ExpectedResult = true)]
        ...
        {
            return Requests.IsLocalUrl(directoryPath, url, whitelist);
        }
    }
}